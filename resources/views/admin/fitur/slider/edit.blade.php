                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul" id="judul" placeholder="Judul Slider" class="form-control @error('judul') is-invalid @enderror" value="{{ $slider->judul }}">
                                            @error('judul')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subjudul" id="subjudul" placeholder="Sub-Judul Slider" class="form-control @error('subjudul') is-invalid @enderror" value="{{ $slider->subjudul }}">
                                            @error('subjudul')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <img src="{{asset('img/slider/'.$slider->banner)}}" id="profile-img-tag" class="img-fluid" />
