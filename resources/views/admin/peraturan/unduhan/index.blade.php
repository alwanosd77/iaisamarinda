        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-10">
                        <h4>{{ $peraturan->label }}</h4>
                    </div>
                    <div class="col-2">
                        <div class="section-header-button float-right">
                            <a href="{{route('admin.unduhan.create',$peraturan->slug)}}" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
$(document).ready(function(){
    $('#table').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: "{{ route('admin.peraturan.show',$peraturan->slug) }}",
        },
        columns:[
        {
            data:'nama',
    ...
    $(document).on('click','.delete', function(){
        ...
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              $.ajax({
                url:"/epanel/unduhan/delete/"+data_id,
                success:function(){
                  setTimeout(function(){
